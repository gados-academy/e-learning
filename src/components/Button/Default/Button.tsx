...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const colorClasses: Record<ButtonColor, Record<ButtonVariant, string>> = {
      primary: {
        solid:
          "bg-primary-500 hover:bg-primary-600 hover:shadow-primary text-white",
      ...
      secondary: {
        solid:
          "bg-secondary-500 hover:bg-secondary-600 hover:shadow-secondary text-white",
      ...
      success: {
        solid:
          "bg-success-500 hover:bg-success-600 hover:shadow-success text-white",
      ...
      warning: {
        solid:
          "bg-warning-500 hover:bg-warning-600 hover:shadow-warning text-white",
      ...
      danger: {
        solid:
          "bg-danger-500 hover:bg-danger-600 hover:shadow-danger text-white",
